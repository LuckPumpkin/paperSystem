...
<head runat="server">
    ...
    <div>
         <h2>院级其他文件打印</h2><span class="span_px">*新建打印单后打印文件参数将以表格形式展示</span>
        ...
        <dx:ASPxPopupControl ID="popupEdit" runat="server" CloseAction="CloseButton" HeaderText="新建打印" Height="275px" Modal="True" ShowFooter="True" Theme="Aqua" Width="357px" PopupAnimationType="Fade" ShowCloseButton="False" ClientInstanceName="popupEdit" Left="80" Top="100" AllowDragging="True" AllowResize="True">
		...
		case 'Cancel':
            ...
            <ContentCollection>
                <dx:PopupControlContentControl ID="PopupControlContentControl5" runat="server" SupportsDisabledAttribute="True">
                        ...
                        <br />
                        <br />
                        封皮选择：<asp:DropDownList ID="drocover" runat="server" Height="25px" Width="89px">
                ...
                <dx:ASPxPopupControl ID="popupEdit1" runat="server" CloseAction="CloseButton" HeaderText="打印参数编辑" Height="275px" Modal="True" ShowFooter="True" Theme="Aqua" Width="357px" PopupAnimationType="Fade" ShowCloseButton="False" ClientInstanceName="popupEdit1" Left="80" Top="100" AllowDragging="True" AllowResize="True">
            <HeaderImage Url="~/images/edit.png">
            </HeaderImage>
            <FooterStyle>
                <Paddings Padding="5px" />
		...
		case 'Cancel':
            ...
            <ContentCollection>
                <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                        文件名称：<asp:TextBox ID="txtName1" runat="server" Height="25px" Width="151px"></asp:TextBox>   
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        装订方式：<asp:DropDownList ID="drobindMethod1" runat="server" Height="25px" Width="75px">
                            <asp:ListItem Value="骑马订">骑马订</asp:ListItem>
                            <asp:ListItem Value="胶订">胶订</asp:ListItem>
                        </asp:DropDownList>
                        <br /> 
