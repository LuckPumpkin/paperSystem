<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResitAudit.aspx.cs" Inherits="WebForms_PrintAdmin_ResitAudit" %>
    ...
    <div>
        <h2>补考打印审核</h2>
         <fieldset>
                <legend>查询条件</legend>
                <br />
                试卷张数大于<asp:DropDownList ID="DropDownList3" runat="server">
                    <asp:ListItem Value="0">0</asp:ListItem>
                    <asp:ListItem Value="6">6</asp:ListItem>
                    <asp:ListItem>8</asp:ListItem>
                    <asp:ListItem>10</asp:ListItem>
                </asp:DropDownList>
                张&nbsp;&nbsp;&nbsp; 白纸张数大于<asp:DropDownList ID="DropDownList4" runat="server">
                    <asp:ListItem Value="0">0</asp:ListItem>
        ...
        <asp:SqlDataSource ID="sdsPaperAudit" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnStr %>" SelectCommand="SELECT Course.course_no, Course.course_name, Paper.paper_num, Paper.whitePaper_num, Paper.paper_copyNum, Paper.ID AS PaperID, Paper.flag, Course.teachingPlan, Course.course_dept, Course.course_teacherno, Paper.paper_AorB FROM Course INNER JOIN Paper ON Course.ID = Paper.courseID WHERE (Paper.flag LIKE '补考') AND (Paper.paper_state LIKE '%试卷印刷部待审%') AND (Paper.paper_num &gt; @paper_num) AND (Paper.whitePaper_num &gt; @whitePaper_num)">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList3" DefaultValue="0" Name="paper_num" PropertyName="SelectedValue" />
                <asp:ControlParameter ControlID="DropDownList4" DefaultValue="0" Name="whitePaper_num" PropertyName="SelectedValue" />
            </SelectParameters>
        </asp:SqlDataSource>
