...
public partial class WebForms_CollegeAdmin_OtherBill : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (gvOrder.Rows.Count >= 0)
        {
            ...
            {
                sum += Convert.ToDouble(gvOrder.Rows[i].Cells[10].Text);
            }
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        if (college != "%")
        {
            filename = college + "其他结账账单.xls";
        }
        else
        {
            filename = "全部学院其他结账账单.xls";
        }
